...
st.subheader("Input Parameters (leave empty to optimize)")
input_names = [
...
variable_bounds = {
    ...
    "slag_ratio": (0.45, 0.72),
    "O2_per_material": (182, 266),
    "coal_per_material": (0, 0.08)
}
...
for i, name in enumerate(input_names):
    ...
    try:
        ...
        free_indices.append(i)  # mark as free if left blank
...
def objective(x_free):
    ...
    y_pred = model.predict(X_array)[0]   # LightGBM Booster predict
...
cu_slag_pred = model.predict(X_final)[0]
